...
WebUI.waitForElementClickable(findTestObject('Object Repository/Deakin_University/Button_Enquiry_Now'), 10)
WebUI.click(findTestObject('Object Repository/Deakin_University/Button_Enquiry_Now'))
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Deakin_University/Button_Submit'), 10)
WebUI.click(findTestObject('Object Repository/Deakin_University/Button_Submit'))
