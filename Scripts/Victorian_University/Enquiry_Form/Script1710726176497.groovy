...
//WebUI.callTestCase(findTestCase('Test Cases/Victorian_University/Reusuable_Testcases/Navigate_URL'), [:], FailureHandling.STOP_ON_FAILURE)

//Navigate to home page
WebUI.callTestCase(findTestCase('Test Cases/Victorian_University/Reusuable_Testcases/Navigate_HomePage'), [:], FailureHandling.STOP_ON_FAILURE)

//Clicks the Enquiry Now button
WebUI.waitForElementClickable(findTestObject('Object Repository/Victoria_University/Button_Enquiry_Now'), 10)
WebUI.click(findTestObject('Object Repository/Victoria_University/Button_Enquiry_Now'))
...
//Clicks the Enquiry Now button
WebUI.waitForElementClickable(findTestObject('Object Repository/Victoria_University/Button_Enquiry_Submit'), 10)
WebUI.click(findTestObject('Object Repository/Victoria_University/Button_Enquiry_Submit'))
