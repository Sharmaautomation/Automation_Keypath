...
WebUI.waitForElementClickable(findTestObject('Object Repository/University_of_Canberra/Button_Enquiry_Now'), 10)
WebUI.click(findTestObject('Object Repository/University_of_Canberra/Button_Enquiry_Now'))
